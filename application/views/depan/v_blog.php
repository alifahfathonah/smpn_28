        ...
        <div class="row">
                    ...
                    <div class="blog-tiltle_block">
                        ...
                        <div class="blog-icons">
                            <div class="blog-share_block">
                                <a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>">Lanjutkan</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <form action="<?php echo site_url('blog/search');?>" method="get">
                    <input type="text" name="keyword" placeholder="Cari" class="blog-search" required>
                    <button type="submit" class="btn btn-warning btn-blogsearch">Pencarian</button>
                </form>
