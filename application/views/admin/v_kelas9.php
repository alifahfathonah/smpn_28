            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered data table-striped w3-table-all w3-hoverable" style="font-size:13px;">
                ...
                <tbody>
          				<?php
          					$no=1;
          					foreach ($kelas9->result_array() as $i) :
                ...
                <td><?php echo $no++ ?></td>
                  ...
                  <td><?php echo $kls7;?></td>
                    ...
                    <td style="text-align:right;">
                      ...
                      style="font-size:10";>
                      <a href="<?php echo base_url('admin/kelas9/delete/'.$kelas_id); ?>"
		...
		<div class="modal-content">
			<div class="modal-header">
			 ...
			 <div class="modal-body">
			 	<form action="<?php echo base_url() ?>admin/kelas9/tambah_aksi" method="POST">
...
<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
			 ...
			 <div class="modal-body">
			 	<form action="<?php echo base_url() ?>admin/kelas9/update_siswa" method="POST">
				 <div class="form-group">
                  <label>Id Kelas</label>
                  <input type="number" class="form-control nis" name="kelas_id"  value="<?php echo $k->kelas_id; ?>" placeholder=" Kode Kelas"
                  readonly >
                </div>
