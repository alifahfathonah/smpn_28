            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered data table-striped w3-table-all w3-hoverable" style="font-size:13px;">
                ...
                <tbody>
          				<?php
          					$no=1;
          					foreach ($kelas7->result_array() as $i) :
                       ...
                       $kelas=$i['kelas_tingkat'];
          				$tahun=$i['tahun_pelajaran'];
                    ?>
                <tr>
                <td><?php echo $no++ ?></td>
                    <td><?php echo $nis;?></td>
		...
		<div class="modal-content">
			<div class="modal-header">
			 ...
			 <div class="modal-body">
			 	<form action="<?php echo base_url() ?>admin/kelas7/tambah_aksi" method="POST">
...
<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
			 ...
			 <div class="modal-body">
			 	<form action="<?php echo base_url() ?>admin/kelas7/update_siswa" method="POST">
				 <div class="form-group">
                  <label>Id Kelas</label>
