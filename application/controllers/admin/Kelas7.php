...
class  Kelas7 extends CI_Controller{
    ...
    function index(){
        $data['kelas7'] = $this->m_kelas7->get_siswa_7();
    ...
    function tambah_aksi(){
        $data = array(
            ...
            'tahun_pelajaran'=>$this->input->post('tahun_pelajaran'));
             ...
             if ($this->db->insert('tbl_kls7',$data)) {
    ...
    public function delete($kelas_id){
        if ($this->db->delete('tbl_kls7',array('kelas_id'=>$kelas_id))) {
    ...
    function update_siswa(){
        ...
        //    $nis=strip_tags($this->input->post('nis'));
           ...
           $tahun_pelajaran=strip_tags($this->input->post('tahun_pelajaran'));
             ...
             $this->m_kelas7->update_kelas($id_kelas,$kelas_tingkat,$tahun_pelajaran);
           echo $this->session->set_flashdata('msg','info');
           redirect('admin/kelas7');
